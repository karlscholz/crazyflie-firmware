...
if firstID == 0:
    firstAdress = "radio://0/80/2M/E7E7E7E700"
elif firstID < 15:
    firstAdress = "radio://0/80/2M/E7E7E7E70"+str(format(firstID, 'x')).upper()
else:
...
if adressCount >= 0 and adressCount < 256:
    for i in range(firstID, lastID):
        if i<15:
            adressList.append("radio://0/80/2M/E7E7E7E70"+str(format(i+1, 'x')).upper())
        else:
