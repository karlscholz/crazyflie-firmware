...
LOG_GROUP_START(RL_A)
LOG_ADD(LOG_FLOAT, rlP00, &rlState[0].P[0][0])
LOG_ADD(LOG_FLOAT, rlP01, &rlState[0].P[0][1])
LOG_ADD(LOG_FLOAT, rlP02, &rlState[0].P[0][2])
LOG_ADD(LOG_FLOAT, rlP10, &rlState[0].P[1][0])
LOG_ADD(LOG_FLOAT, rlP11, &rlState[0].P[1][1])
LOG_ADD(LOG_FLOAT, rlP12, &rlState[0].P[1][2])
LOG_GROUP_STOP(RL_A)
LOG_GROUP_START(RL_B)
LOG_ADD(LOG_FLOAT, rlP20, &rlState[0].P[2][0])
LOG_ADD(LOG_FLOAT, rlP21, &rlState[0].P[2][1])
LOG_ADD(LOG_FLOAT, rlP22, &rlState[0].P[2][2])
LOG_ADD(LOG_FLOAT, rlXp0, &rlState[0].S[STATE_rlX])
LOG_ADD(LOG_FLOAT, rlYp0, &rlState[0].S[STATE_rlY])
LOG_ADD(LOG_FLOAT, rlYa0, &rlState[0].S[STATE_rlYaw])
LOG_GROUP_STOP(RL_B)
LOG_GROUP_START(RL_C)
LOG_ADD(LOG_FLOAT, rlXp1, &rlState[1].S[STATE_rlX])
LOG_ADD(LOG_FLOAT, rlYp1, &rlState[1].S[STATE_rlY])
LOG_ADD(LOG_FLOAT, rlYa1, &rlState[1].S[STATE_rlYaw])
LOG_GROUP_STOP(RL_C)
